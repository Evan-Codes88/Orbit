...
const Navbar = () => {
  ...
  return (
    <header className="bg-[#1E1D2D] border-b border-[#4C4A73] fixed w-full top-0 z-40 backdrop-blur-lg bg-opacity-80">
      <nav className="flex items-center justify-between w-full px-4 sm:px-6 lg:px-8 h-16">
        
        {/* LEFT LOGO */}
        <section className="flex items-center gap-2.5 hover:opacity-80 transition-all">
